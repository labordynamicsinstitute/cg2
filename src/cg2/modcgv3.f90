      ...
      SUBROUTINE MODCG( N, B, X, R, P, Q, MAXIT, RESID, LOGUNIT, FNCGLOG)
!
...
!
      ...
      R = B
      P = 0.0D0
!      BNRM2 = DNRM2(N,B,1)  - Think about using DNRM2 instead of DOT_PRODUCT to save memory bandwidth
...
10    FORMAT(" Iteration ",I4," Norm of residual ", E15.9, " Relative error ", E15.9)
      ...
      OPEN(UNIT=LOGUNIT,FILE=FNCGLOG,STATUS="OLD",POSITION="APPEND")
